...
def deltatime(count):
    txtt=open("C:\\Users\\Monish\\Documents\\COSMIC RAY\\cosmicray\\alta\\output\\blah.txt")
    txtt=list(txtt)
    y=txtt[count]
    m=y[0]
...
def playMIDI(x,counter,counter2):
